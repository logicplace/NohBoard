...
namespace ThoNohT.NohBoard.Keyboard.ElementDefinitions
{
    ...
    /// </summary>
    [DataContract(Name = "EmaKeyboardKey", Namespace = "")]
    public class EmaKeyboardKeyDefinition : EmaKeyDefinition
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmaKeyboardKeyDefinition" /> class.
        /// </summary>
        ...
        public EmaKeyboardKeyDefinition(
            int id,
        ...
        public bool BordersWith(EmaKeyboardKeyDefinition otherKey)
        {
        ...
        {
            return new EmaKeyboardKeyDefinition(
                this.Id,
        ...
        /// </summary>
        /// <param name="index">The index of the boundary point in <see cref="EmaKeyDefinition.Boundaries"/>.</param>
        ...
        protected override EmaKeyDefinition MoveBoundary(int index, Size diff)
        {
        ...
        protected override EmaKeyDefinition MoveText(Size diff)
        {
            return new EmaKeyboardKeyDefinition(
                this.Id,
        ...
        public override EmaKeyDefinition RemoveBoundary()
        {
        ...
        public override EmaKeyDefinition AddBoundary(TPoint location)
        {
            if (this.RelevantManipulation == null) return this;
        ...
        public override EmaKeyDefinition UnionWith(List<EmaKeyDefinition> keys)
        {
            return this.UnionWith(keys.ConvertAll(x => (EmaKeyboardKeyDefinition)x));
        }
        ...
        public override EmaKeyDefinition ModifyMouse(List<TPoint> boundaries = null, int? keyCode = null, string text = null, TPoint textPosition = null)
        {
        ...
        /// <param name="textPosition">The new text position, or <c>null</c> if not changed.</param>
        /// <returns>The new element definition.</returns>
        public EmaKeyboardKeyDefinition Modify(
        ...
        /// <param name="keys">The keys to union with.</param>
        /// <returns>A new key definition with the updated region.</returns>
        private EmaKeyboardKeyDefinition UnionWith(IList<EmaKeyboardKeyDefinition> keys)
        {
        ...
        {
            if (!(other is EmaKeyboardKeyDefinition kkd)) return true;
