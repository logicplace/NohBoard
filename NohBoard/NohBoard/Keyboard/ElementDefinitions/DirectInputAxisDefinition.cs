    ...
    public class DirectInputAxisDefinition : DirectInputElementDefinition {
        ...
        public void Render(Graphics g, Dictionary<Guid, int[]> directInputAxis, bool shift, bool capsLock) {
            ...
            try {
                ...
                int axis1Value = axis1Number != null && axis != null ? axis[(int)axis1Number] : AxisOneMax / 2;
                int axis2Value = axis2Number != null && axis != null ? axis[(int)axis2Number] : AxisTwoMax / 2;
